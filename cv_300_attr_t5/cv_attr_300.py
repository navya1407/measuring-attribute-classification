...
with open('/home/navya/gpu/cv_attr/cv_f1_attr/t5_true/true_300_attr.json') as jsonfile:
...
def obj(trial: optuna.Trial):
 ...
 # val_dataset = df_val.apply(lambda row: preprocess(row,tokenizer), axis=1)
  ...
  dir='/home/navya/gpu/cv_attr/cv_f1_attr/cv_300_attr/checkpoints/'+f"trial_{trial.number}"
  ...
  for fold, (train_idx, val_idx) in enumerate(kf.split(train_dataset)):
    ...
    print(eval_output)
    score.append(eval_output['eval_f1'])
...
study = optuna.create_study(study_name="hyper-parameters-cv55555-attr-300",storage=storage_name, direction="maximize",sampler=sampler)
...
for key, value in study.best_trial.params.items():
    d[key]=value
    print(f"    {key}: {value}")
with open('/home/navya/gpu/cv_attr/cv_f1_attr/cv_300_attr/final_params.json', 'w') as f:
    json.dump(d, f)


joblib.dump(study, "/home/navya/gpu/cv_attr/cv_f1_attr/cv_300_attr/study.pkl")
